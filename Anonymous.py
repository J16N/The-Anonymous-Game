...
def origame():
			...
			while True:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nSo you did successfully complete the mission. Kenny Alam's boss was his wife's ex-boyfriend before she married Kenny. \nIt turned out that, due to her rejection of his proposal, he decided to take revenge \nby causing the car accident that killed Kenny's child. \nFive years later, somehow, Kenny learned of this, likely informed by his trustee, who is currently unknown, \nand decided to take revenge by breaching the company's security system \nand publishing all the company's secrets anonymously. \nKenny thought that this would cause a great loss to the company and his boss.\n"
						time.sleep(2)
						return 'level4'
					else:
						print "To view the mail type the serial no."
	...
	class Level4(Scene):
		...
		def enter(self):
			...
			time.sleep(1)
			printf("\nBreaker is a software used to break in to a computer by cracking the password. \nYou can access the software by using the command 'breaker' or '-b', or typing "breaker" in the password field of a login screen. \nNote that these are the official tools downloaded from official servers \nwhich no one has any access to,  other than Anonymous members. \nType 'breaker' in pass field to break passwords using hash algorithm. \n")
			time.sleep(0.5)
			printf("\nThere's a new mail for you.\n\n")
			bgsound()
			while True:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nJoseph Esta has been found guilty of breaching the security of the political community under National Lines. \nUnfortunately, he escaped from the police, but fortunately, police seized his computer, \nbut they were puzzled, since none of them can crack the password. He has used something advanced in his scripting so that \nfailure to input the correct password in time would result in the computer wiping itself of all data. \nGo and hack his computer, the IP address is 145.741.259.32, and reset the password to NONE.\n"
					else:
						print "To view the mail type the serial no."
				elif x == 'ls':
					print "esta.txt"
			...
			while True:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nWe are very glad that you have successfully completed the mission. \nWe sent the password to the police and they were able to access his computer and find some important documents. \nIt was found that he had been bribed to breach the security and the police anticipate that \na few people, who were basically the rivals of the community, were behind this.\n"
						time.sleep(1)
						return 'level5'
					else:
						print "To view the mail type the serial no."
	...
	class Level5(Scene):
		...
		def enter(self):
			...
			time.sleep(1)
			printf("\nCongo! It's a great honour that you have successfully completed the time-trial mission. \nYou have been promoted and some new features have been added to your terminal. \nNow you can ping a IP address to see its status. \nThere's a new mail waiting for you.\n\n")
			bgsound()
			while True:
				x = raw_input('%s$Terminal:~ ' % user)
				if x == "help":
					...
					if x == '01':
						...
						print "\nThis mission might be a little tougher for you. Let's see. \nSyncLink launched a website criticizing the deeds of the Anonymous hackers. \nThey even exposed a few of the members of our group and made a well documented article. \nWe appreciate the hard work the admin put in to make the website, but unfortunately we need to close it down. \nThe site address is 145.366.74.63. \nMake sure you completely shut down the website and delete the content of the server permanently.\n"
					else:
						print "To view the mail type the serial no."
				elif x == 'ping 145.366.74.63':
					time.sleep(1)
					Level1().animate('Pinging 145.366.74.63 with 32 bytes of data', 3)
					print "\nReply from 145.366.74.63: bytes=32 time=47ms TTL=56"
					time.sleep(0.5)
					print "\nReply from 145.366.74.63: bytes=32 time=47ms TTL=56"
					time.sleep(0.5)
					print "\nReply from 145.366.74.63: bytes=32 time=47ms TTL=56"
					...
					print "\nReply from 145.366.74.63: bytes=32 time=47ms TTL=56"
					time.sleep(0.5)
					print "\nPing statistics for 145.366.74.63:"
					...
					try:
						...
						if name == 'admin' and password == 'breaker':
							...
							while time.time() < t_end:
								...
								if y == 'help':
								...
								elif y == 'shut-down 145.366.74.63' or y == '-s 145.366.74.63':
									time.sleep(1)
									...
									if x == "help":
										...
										time.sleep(1)
										Level1().animate('Pinging 145.366.74.63 with 32 bytes of data', 2)
										time.sleep(1)
										print "\nRequest timed out"
										time.sleep(0.5)
										print "\nRequest timed out"
			...
			while True:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nBravo! The admin does not doubt that it was us who closed his website. We have given him a warning. \nThe police are trying to trace us. Beware."
						time.sleep(1)
						return 'level6'
					else:
						print "To view the mail type the serial no."
	...
	class Level6(Scene):
		...
		def enter(self):
			...
			Level3().printinoneline("Getting required modules...", "Applying Updates...", "Activating TX001...", "Checking log files...", "Files successfully checked.")
			time.sleep(1)
			printf("\nThe police are trying to trace us. I have added an advanced firewall that will control any traffic you send and receive. \nI only allow you to receive authorized data and unauthorized data is immediately denied. \nBut the police are trying to DDoS us and I don't know how long I'll able to hold them back. \nUnfortunately, during a large amount of request handling I encountered some problems with securely masking the IP of your computer. \nFrom now on, before you connect to another computer, you need to first connect to our private proxy \nand only then will you be authorized to connect to the computer. \nIt's gonna take a lot to deal with all of this, so I'll be out for the next few levels.\n\n")
			time.sleep(1)
			...
			while True:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nThe corrupted policemen of the community are constantly trying to reach us. They have hired some hackers as well. \nAfter many other attempts failed, they are trying to DDoS us. \nDue to this, quite a few of our servers got overloaded with unauthorized client requests and as a result they will be down for some time. \nWe have a very goos security system so we're safe for a while \nbut it could also be hacked. We have found that Brian De Luas, the officer in-charge, has been bribed to do this. \nHe has two bank accounts. He always keeps all his black money in his second bank account. \nThe name of the bank is FOU INTERNATIONAL. \nGo and hack his bank account and transfer all the money to our temporary account under the name 'AnnoTemp'. \nThe IP address of the bank is 205.145.23.452. We got the info that TX-001 is unable to mask your IP, \nso you'll need to connect to one of our proxy sites that could mask your IP for a very short period of time \nbefore you can connect to the original server. The bank is highly secured so you may note that \nas soon as you use your password breaker tool the security may fire up traceback processes. \nSince our servers are located quite far away, they will need some time to locate you. \nWithin that time you need to complete your work. \nThe IP of our first and second servers are 120.45.236.12 and 120.36.412.10 respectively. \nGood Luck on your mission.\n"
					else:
						print "To view the mail type the serial no."
			...
			while True:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nWell done! We distributed that money to a charity fund. \nBrian was shocked to lose such a huge amount and most likely \bhad been admitted to the hospital for serious heart-attack. Good job!\n"
						time.sleep(1)
						return 'level7'
					else:
						print "To view the mail type the serial no."
	...
	class Level7(Scene):
		...
		def enter(self):
			...
			printf("\n\nWE ARE HACKED!!! There's someone or some people who is constantly trying to reach you. \nHe/they initially tried a DDoS attack. Unfortunately I failed to handle the large amount of requests. \nThey injected an undetectable, extremely well coded virus in your system which automatically multiplied before I could detect it. \nThere's no time now. The virus was made to tamper my programming and then he/they will  hack your database. \nI'm encrypting your database with a master key, which should keep them busy for a week or so \nbefore they could successfully hack into it.\n\n")
			time.sleep(1)
			printf("\nI'm bu0x67ged. They ar0x45 trying to reprogra0x6D me. \nSo, to ensure your secur0x69ty I'm shutting myself down. Good lu0x63k!\n\n")
			time.sleep(1)
			...
			while time.time() < t_end:
				...
				if x == "help":
					...
					if x == '01':
						...
						print "\nIf you are seeing this message then have already been hacked. \nWe are sorry to say but we had to disconnect from you so that no confidential info gets to the public. \nThe hacker is very clever. \nThe hacking was too low-level to get detected by our system. Maybe you became the victim of traceback \nand he probably will match the possible values with the key to hack your database for your info.\nThere's some hidden commands in your terminal. They are generally accessed by putting -h at the commands. \n'.destroy <SysFile>' and '.shtdwn' is mainly used to delete the system generated files and shutting down the system respectively. \nThese commands were usually controlled by TX001 so you didn't need it unless you did something crazy to the system. \nIn order to preserve your anonymity you need to escape from that hacker. \n\nRemember 'DO NOT GIVE ANYONE ANY CHANCE TO HACK YOU'. Good Luck!\n"
						time.sleep(10)
						winsound.PlaySound(None, winsound.SND_PURGE)
						return 'level8'
					else:
	...
	class Level8(Scene):
		...
		def enter(self):
			...
			time.sleep(1)
			print "\x1b[31m"
			printf("Hello hacker. Ever thought that you could also get hacked? \nYou are one of the most novice hackers I've ever seen, I mean, you didn't even think that \nestablishing a connection with a remote server could leave a little bit of trace too. \nYou're just a gooddamned piece of shit. \nNow look, since I've taken control of your terminal, I can get your bio \nand publish it in front of whole world....ha ha ha ha ha.....\n\n")
			time.sleep(1)
			printf("\nWell let me challange you. I'll give you three chances to escape. \nI'll ask you three questions and you have to answer me those. \nIf you correctly answer all three I'll give you a chance to escape. \nBut if you fail to answer any one of them then .....ha ha ha ha ha......\n\n")
			time.sleep(1)
				...
				if y == 'skull' or y == 'a skull' or y == 'the skull':
					...
					if p == 'temperature' or p == 'a temperature' or p == 'the temperature':
						...
						if q == 'a deck of cards' or q == 'a pack of cards' or q == 'cards' or q == 'a trump cards' or q == 'the trump cards' or q == 'trump cards':
							printf("\nWell I won't congratulate you but if you were too smart then you would have typed those sys commands \nwhich you were told about in the mail rather than answering my questions. \nHa ha ha ha ha........I just changed the prompt sign....and if you can't really figured it out \nthen you proved yourself a SHIT... \n\n")
							time.sleep(2)
							return 'death'
					...
					print "\x1b[32m\x1b[1m"
					printf("\n\nYou were probably using cheat-codes to complete the game and the hacker thus banned you from your system.")
					time.sleep(1)
					return 'death'
				elif y == '':
					x
	...
	class Finished(Scene):
		...
		def enter(self):
			winsound.PlaySound(None, winsound.SND_PURGE)
			print "\nYou are successful in preserving your anonymity. \nLater, you got some other contracts and got a job in reputable software company."
			time.sleep(3)
			credits()
	...
	def play(self):
		...
		if x == True and y == True and z == True:
			...
			if choice == 'yes':
				...
				time.sleep(1)
				printf("\nBut that doesn't really matter. \nFor now you can imagine me as a GOD who is presently seeing you, has access to your computer, and knows almost everything about you.")
				time.sleep(1)
				printf("\nWhat if, one day, you woke up and find yourself locked into the dark room?")
				time.sleep(2)
				printf("\nWhat if you lost all your family and friends just because they didn't understand you")
				printf("\nAnd you don't even know how to make them realize that you aren't guilty?")
				time.sleep(2)
				printf("\nWhat would you do when you know someone is in danger but can't help them?")
				time.sleep(1)
				printf("\nWhat will you do when all of society breaks down at the core?")
				time.sleep(2)
				printf("\nThese questions may seem a bit odd, but they are actually not.")
				time.sleep(1)
				...
				printf("\nRoom-2:- This room contains full of Assassins who are eager to kill any humans who step inside.")
				...
				while True:
					...
					if y == 'room-1' or y== '1' or y == 'room1':
						printf("\n\nYour body was immediately engulfed in flames, burning you to a crisp.")
    					printf("\nPoor Man!")
    					time.sleep(2)
    					exit(1)
    					...
    					printf("\nGood job!")
    					time.sleep(1)
    					printf("\n\nCongratulations! You have successfully passed our test. \nYou can now join our Anonymous hacking group.")
    					time.sleep(1)
    					printf("\n\nI'll bet you're wondering what Anonymous hackers are.")
    					printf("\nWell, to be brief, Anonymous hackers are hackers who do good things for \nthe common good, usually by hacking means.")
    					printf("\nWell nowadays, since everything is operated by computers, it is easy for us \nto reveal the truth behind many influential political associations, \nwho usually just want to conceal their true identity or their misdeeds, usually by hacking \ntheir sites or emails or computers.")
    					printf("\nAlthough I hate the term, you could call us Hacktivists if you want.")
    					printf("\nWe have chosen you out of over a million possible candidates.")
