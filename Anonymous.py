	...
	def play(self):
		...
		if x == True and y == True and z == True:
			...
			if choice == 'yes':
				...
				time.sleep(1)
				printf("\nBut that doesn't really matter. \nFor now you can imagine me as a GOD who is presently seeing you and has access to your computer and knows almost everuthing about you.")
				time.sleep(1)
				...
				while True:
					...
					if y == 'room-1' or y== '1' or y == 'room1':
						printf("\n\nYou got ultimately burnt into the room and died.")
    					printf("\nPoor Man!")
    					time.sleep(2)
    					exit(1)
